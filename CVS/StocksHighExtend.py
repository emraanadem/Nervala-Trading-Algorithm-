...
class History:
    ...
    def Four_Hour(instrument):
        ...
        for a in client.list_aggs(ticker=instrument, multiplier=4, timespan="hour", from_=refdayfourhour, to=today, limit=50000):
            History.fourhour.append(a.high)

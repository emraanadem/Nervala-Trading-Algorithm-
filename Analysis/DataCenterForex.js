...
let baseURL = `https://api-fxpractice.oanda.com/v3/accounts/${accountID}/instruments/${instrument}/candles?`
...
function Assigner () {
  values = {}
  const timeperiods = ['Five_Min', 'Fifteen_Min', 'Thirty_Min', 'One_Hour', 'Two_Hour', 'Four_Hour', 'Daily', 'Weekly', 'Five_Min Extend', 'Fifteen_Min Extend', 'Thirty_Min Extend', 'One_Hour Extend', 'Two_Hour Extend', 'Four_Hour Extend', 'Daily Extend', 'Weekly Extend']
...
async function Five_Min () {
  const params = 'count=1000&granularity=M5'
...
async function Fifteen_Min () {
  const params = 'count=1000&granularity=M15'
...
async function Thirty_Min () {
  const params = 'count=1000&granularity=M30'
...
async function One_Hour () {
  const params = 'count=1000&granularity=H1'
...
async function Two_Hour () {
  const params = 'count=1000&granularity=H2'
...
async function Four_Hour () {
  const params = 'count=1000&granularity=H4'
...
async function Daily () {
  const params = 'count=1000&granularity=D'
...
async function Weekly () {
  const params = 'count=1000&granularity=W'
...
async function Five_Min_Extend () {
  const params = 'count=2500&granularity=M5'
...
async function Fifteen_Min_Extend () {
  const params = 'count=2500&granularity=M15'
...
async function Thirty_Min_Extend () {
  const params = 'count=2500&granularity=M30'
...
async function One_Hour_Extend () {
  const params = 'count=2500&granularity=H1'
...
async function Two_Hour_Extend () {
  const params = 'count=2500&granularity=H2'
...
async function Four_Hour_Extend () {
  const params = 'count=2500&granularity=H4'
...
async function Daily_Extend () {
  const params = 'count=2500&granularity=D'
...
async function Weekly_Extend () {
  const params = 'count=2500&granularity=W'

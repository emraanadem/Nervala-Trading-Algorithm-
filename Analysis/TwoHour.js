...
class Two_Hour_Functions {
  ...
  static HistoryAssigner () {
    ...
    Two_Hour_Functions.extendHist = dataset['Two_Hour Extend'].c
    Two_Hour_Functions.extendHigh = dataset['Two_Hour Extend'].h
    Two_Hour_Functions.extendLow = dataset['Two_Hour Extend'].l
  }
  ...
  static overall () {
    ...
    const result = Two_Hour_Functions.analysis(studylist, extendedhistory, pricerange)
    return result
  }
  ...
  static supreslevs () {
    ...
    for (let item = 0; item < smaller.length; item++) {
      if (Math.abs(Two_Hour_Functions.valdiff(price, smaller[item])) > 0.05) {
        smallertwo.push(smaller[item])
      }
    }
    for (let item = 0; item < larger.length; item++) {
      if (Math.abs(Two_Hour_Functions.valdiff(price, larger[item])) > 0.05) {

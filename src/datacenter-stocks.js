...
const refdayfive = moment().subtract(5, 'days').format().split('T')[0]
const refdayfifteen = moment().subtract(16.25, 'days').format().split('T')[0]
const refdaythirty = moment().subtract(35, 'days').format().split('T')[0]
const refdayhour = moment().subtract(69, 'days').format().split('T')[0]
const refdaytwohour = moment().subtract(124.5, 'days').format().split('T')[0]
const refdayfourhour = moment().subtract(248, 'days').format().split('T')[0]
const refdaydaily = moment().subtract(1062.5, 'days').format().split('T')[0]
const refdayweekly = moment().subtract(5115, 'days').format().split('T')[0]
let instrument = ''

let baseURL = 'https://api.polygon.io/v2/aggs/ticker/' + instrument + '/range/'
...
async function Five_Min () {
  ...
  while ('next_url' in data) {
    if ('next_url' in data) {
      const id = data.next_url.split('/')[10]
